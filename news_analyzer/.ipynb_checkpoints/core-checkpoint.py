...
if __name__ == '__main__':
    ...
    user_selection = raw_input('keyword : ')
    if user_selection == 1:
      while True:
      ...
      file_name = raw_input('keyword : ')
      file_links = open(file_name, "r").read()
      link_list = map(lambda x: (unicode(x), 'News Title <>', '24-Oct-2016'), file_links.split(","))
      retrieve_data_from_links(link_list, 'data/temp/')
